...
@Service
class VehicleModelService(private val repo: GenericRouteRepository) {

    private val tableInfo = RouteTableRegistry.resolve("vehicle-models")
        ?: error("vehicle-models not found in registry")
    ...
    fun create(data: Map<String, String?>): Mono<Map<String, Any?>> {
        ...
        val dbMap = linkedMapOf(
            "vehicle_model_id" to id,
            "model_name" to (data["modelName"] ?: error("modelName is required"))
        )

...
-- GPS tracking (партиционировано по RECORDED_AT, 12 партиций от 2026-09)
...
-- Партиции: ASOP_GPS_TRACKING_YYYY_MM (создаются Liquibase или @Scheduled)

-- API-ключи для публичных клиентов (пассажиры)
